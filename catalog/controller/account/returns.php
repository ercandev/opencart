...
class Returns extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/returns', $url, true)
		);
		...
		$pagination->url = $this->url->link('account/returns', 'page={page}', true);
	...
	public function info() {
		...
		if ($return_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('account/returns/info', 'return_id=' . $this->request->get['return_id'] . $url, true)
			);
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$return_id = $this->model_account_returns->addReturn($this->request->post);
