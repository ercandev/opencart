...
class Weight {
  private $registry;
	...
	public function __construct($registry) {
		...
		$weight_class_query = $this->registry->get('db')->query("SELECT * FROM " . DB_PREFIX . "weight_class wc LEFT JOIN " . DB_PREFIX . "weight_class_description wcd ON (wc.weight_class_id = wcd.weight_class_id) WHERE wcd.language_id = '" . (int)$this->registry->get('config')->get('config_language_id') . "'");
