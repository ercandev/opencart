...
class Length {
  private $registry;
	...
	public function __construct($registry) {
		...
		$length_class_query = $this->registry->get('db')->query("SELECT * FROM " . DB_PREFIX . "length_class mc LEFT JOIN " . DB_PREFIX . "length_class_description mcd ON (mc.length_class_id = mcd.length_class_id) WHERE mcd.language_id = '" . (int)$this->registry->get('config')->get('config_language_id') . "'");
